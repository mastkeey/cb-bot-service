...
public class DeleteWorkspace implements Command {
    ...
    public String getCommand() {
        return DELETE_WORKSPACE_COMMAND;
    }

    @Override
    public String getDescription() {
        return DELETE_WORKSPACE_COMMAND_DESCRIPTION;
    }
    ...
    public SendMessage handle(Update update) {
        ...
        return Objects.isNull(workspaceList)
                ...
                : new SendMessage(update.message().chat().id(), CHOOSE_WORKSPACE_TO_DELETE)
                .replyMarkup(KeyboardUtil.createKeyboard(
                        workspaceList.buttonInfoList(), DEFAULT_PAGE_NUMBER, workspaceList.pageTotal(), Type.WORKSPACE, Action.DELETE
                ));
    }
}
