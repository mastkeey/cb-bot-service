...
import org.example.telegrambot.command.file.DeleteFile;
...
public class DeleteFileTest {
    ...
    private String success = "Выбери файл который хочешь удалить";
    ...
    @Test
    void deleteFileCommand_ShouldReturnSuccess_WhenHandleMethodInvoke() {
        when(documentService.getFileList(anyInt(), anyInt(), anyLong())).thenReturn(keyboardInfo);

        SendMessage msg = deleteFile.handle(update);
    ...
    @Test
    void deleteFileCommand_ShouldReturnFailed_WhenHandleMethodInvoke() {
